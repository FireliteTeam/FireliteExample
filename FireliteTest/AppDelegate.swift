...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "FireliteTest")
...
extension AppDelegate {
    func loadContext() -> NSManagedObjectContext?{
        ...
        guard
            ...
            let schemaURL = Bundle.main.url(forResource: "FireliteTest", withExtension: "momd"),
            let model = NSManagedObjectModel(contentsOf: schemaURL) else { return nil }
        
        
        let storageURL = documentDirectory.appendingPathComponent("FireliteTest.sqlite")
        print(storageURL)
